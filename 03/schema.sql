...
create table vsisp09.apartment (ID INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY, CITY VARCHAR(50), POSTAL_CODE VARCHAR(50), STREET VARCHAR(50), STREET_NUMBER VARCHAR(25), SQUARE_AREA VARCHAR(50), ESTATE_AGENT INTEGER, FLOOR INTEGER, RENT DOUBLE, ROOMS INTEGER, BALCONY SMALLINT, BUILT_IN_KITCHEN SMALLINT, TENANCY_CONTRACT INTEGER, PERSON INTEGER);
